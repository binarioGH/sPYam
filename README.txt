this project has "sPYam" as name because is concatenation of "spam" and "py" of python.
is a project to send a lot of messages for emails in a text file, for get this emails you can use 
